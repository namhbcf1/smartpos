...
const WarrantyWorkflow: React.FC = () => {
  ...
  const mockWorkflows: WorkflowInstance[] = [
    {
      id: 'workflow_1',
      warranty_claim_id: 'claim_001',
      status: 'active',
      current_step: 'step_2',
      progress_percentage: 40,
      start_time: '2024-01-15T08:00:00Z',
      estimated_completion: '2024-01-17T08:00:00Z',
      ...
      steps: [
        {
          id: 'step_1',
          name: 'Tiếp nhận và phân tích',
          description: 'Tiếp nhận sản phẩm, kiểm tra và phân tích vấn đề',
          status: 'completed',
        ...
        {
          id: 'step_2',
          name: 'Chẩn đoán kỹ thuật',
          description: 'Thực hiện chẩn đoán chi tiết và đưa ra phương án xử lý',
          status: 'in_progress',
        ...
        },
        {
          id: 'step_3',
          name: 'Sửa chữa',
          description: 'Thực hiện sửa chữa theo phương án đã xác định',
          status: 'pending',

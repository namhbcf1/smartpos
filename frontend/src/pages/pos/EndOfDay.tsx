...
export default function EndOfDay() {
  ...
  const loadDailyData = async () => {
    ...
    try {
      const [summaryRes, reportRes] = await Promise.all([
        api.get('/api/reports/sales', { params: { range: 'today' } }),
        api.get('/api/reports/daily', { params: { date: new Date().toISOString().split('T')[0] } })
      ])
  ...
  const closeDay = async () => {
    setClosing(true)
    try {
      await api.post('/api/reports/end-of-day')
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 flex items-center justify-center">
        ...
        >
          ...
          <h2 className="text-xl font-semibold text-gray-900 dark:text-white">Đang tải báo cáo...</h2>
        </motion.div>
      </div>
    )
  }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
      ...
      <div className="p-6 space-y-6">
        ...
        >
          {sum ? (
            ...
            <div className="col-span-5 text-center py-12">
              ...
              <p className="text-gray-500 dark:text-gray-400">Không có dữ liệu báo cáo</p>
            </div>
          )}
        </motion.div>
          ...
          >
            ...
            <Card className="shadow-xl border-0 bg-white/70 dark:bg-gray-800/70 backdrop-blur-lg">
              ...
              <CardContent className="space-y-4">
                <div className="flex justify-between items-center">
                  <span className="text-gray-600 dark:text-gray-400">Giá trị đơn hàng TB:</span>
                  <span className="font-semibold">
                    {sum.sales_count > 0 ? (sum.total / sum.sales_count).toLocaleString('vi-VN') : '0'} ₫
                  </span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-gray-600 dark:text-gray-400">Giờ cao điểm:</span>
        ...
        >
          <Card className="shadow-xl border-0 bg-gradient-to-r from-red-50 to-orange-50 dark:from-red-900/20 dark:to-orange-900/20">
            <CardContent className="p-8">
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white">Chốt ngày</h3>
                    <p className="text-gray-600 dark:text-gray-400">

...
const CustomerDebts: React.FC = () => {
  ...
  const filteredDebts = debts.filter(debt => {
    ...
    if (debtRange === 'low') matchesDebtRange = debt.currentDebt < 1000000
    else if (debtRange === 'medium') matchesDebtRange = debt.currentDebt >= 1000000 && debt.currentDebt < 5000000
    else if (debtRange === 'high') matchesDebtRange = debt.currentDebt >= 5000000
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Công nợ khách hàng</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div>
              ...
              >
                ...
                <option value="high">Trên 5M</option>
              </select>
            </div>
                  ...
                  return (
                    <tr key={debt.id} className="border-b hover:bg-gray-50">
                      <td className="p-3">
                        ...
                        <div className="text-sm text-gray-500">{debt.customerId}</div>

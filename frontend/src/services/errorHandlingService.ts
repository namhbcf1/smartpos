...
class ErrorHandlingService {
   ...
   */
  private handleUnauthorizedError(errorResponse: ErrorResponse, context: ErrorContext): ErrorNotification {
    return {
      id: this.generateErrorId(),
      type: 'error',
   ...
   */
  private handleRateLimitError(errorResponse: ErrorResponse, context: ErrorContext): ErrorNotification {
    return {
      id: this.generateErrorId(),
      type: 'warning',

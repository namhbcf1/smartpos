-- ==========================================
-- COMPUTERPOS PRO - WARRANTY SYSTEM MIGRATION
-- Add warranty and serial number management tables
-- ==========================================

-- Add missing columns to existing serial_numbers table
ALTER TABLE serial_numbers ADD COLUMN supplier_id INTEGER;
ALTER TABLE serial_numbers ADD COLUMN location TEXT;
ALTER TABLE serial_numbers ADD COLUMN condition_notes TEXT;
...
CREATE INDEX IF NOT EXISTS idx_serial_numbers_dates ON serial_numbers(purchase_date, sale_date);
